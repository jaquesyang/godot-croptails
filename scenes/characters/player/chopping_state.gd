...
func _on_enter() -> void:
	if player.player_direction == Vector2.UP:
		...
		hit_component_collision_shape.position = Vector2(0, -18.0)
		#hit_component_collision_shape.position = Vector2(3.0, -20.0)
	elif player.player_direction == Vector2.LEFT:
		animated_sprite_2d.play("chopping_left")
		hit_component_collision_shape.position = Vector2(-9.0, 0)

...
func _ready() -> void:
	print("hurt_component:", hurt_component.tool)
...
func add_stone_scene() -> void:
	var store_instance = stone_scene.instantiate() as Node2D
	store_instance.global_position = global_position
	get_parent().add_child(store_instance)
